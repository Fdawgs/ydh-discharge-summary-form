"use strict";function asyncGeneratorStep(gen,resolve,reject,_next,_throw,key,arg){try{var info=gen[key](arg);var value=info.value}catch(error){reject(error);return}if(info.done){resolve(value)}else{Promise.resolve(value).then(_next,_throw)}}function _asyncToGenerator(fn){return function(){var self=this,args=arguments;return new Promise(function(resolve,reject){var gen=fn.apply(self,args);function _next(value){asyncGeneratorStep(gen,resolve,reject,_next,_throw,"next",value)}function _throw(err){asyncGeneratorStep(gen,resolve,reject,_next,_throw,"throw",err)}_next(undefined)})}}function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function")}}function _defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value"in descriptor)descriptor.writable=true;Object.defineProperty(target,descriptor.key,descriptor)}}function _createClass(Constructor,protoProps,staticProps){if(protoProps)_defineProperties(Constructor.prototype,protoProps);if(staticProps)_defineProperties(Constructor,staticProps);return Constructor}var ActiveDirectory=require("activedirectory");
...
require("pg"),Pool=_require.Pool;
var retrieveInProgress=require("./middleware/postgresql-inprogress.middleware");
var retrieveAwaitSignOff=require("./middleware/postgresql-awaitingsignoff.middleware");
var fhirPatientRecord=require("./middleware/fhir-patient.middleware");
var fhirAllergyRecord=require("./middleware/fhir-allergyintolerance.middleware");
var fhirEncounterRecord=require("./middleware/fhir-encounter.middleware");
var adGroupMembership=require("./middleware/ad-authorization.middleware");
var insertUpdateRecord=require("./middleware/postgresql-upsert.middleware");
var gatherCustomParams=require("./middleware/gather-custom-params.middleware");var

Server=/*#__PURE__*/function(){
/**
	 * @param {Object} config - Server configuration values.
	 */
function Server(){var config=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{};_classCallCheck(this,Server);
this.config=config;
...
/**
	 ...
	 */_createClass(Server,[{key:"configureFhirRouting",value:function configureFhirRouting(
fhirConconfig){
...
retrieveInProgress(this.pool),/*#__PURE__*/function(){var _ref=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(
function _callee(req,res){return regeneratorRuntime.wrap(function _callee$(_context){while(1){switch(_context.prev=_context.next){case 0:
res.render("./pages/patient_landing",req.customparams);case 1:case"end":return _context.stop();}}},_callee)}));return function(_x,_x2){return _ref.apply(this,arguments)}}());
...
/**
	 ...
	 */},{key:"configureHelmet",value:function configureHelmet(
helmetConfig){
...
/**
	 ...
	 */},{key:"configureMiddleware",value:function configureMiddleware()
{
...
/**
	 ...
	 */},{key:"configureActiveDirectory",value:function configureActiveDirectory(
...
/**
	 ...
	 */},{key:"configurePostgresqlgres",value:function configurePostgresqlgres(
postgresqlConfig){
...
/**
	 ...
	 */},{key:"configureRouting",value:function configureRouting(
fhirConconfig){
this.app.get(
"/",
gatherCustomParams(),
...
this.app.get("/contributors",function(req,res){
