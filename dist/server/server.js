...
return this.app.get("/searchpatient",fhirPatientRecord(a),function(a,b){b.render("./pages/patient_confirmation",a.patientresource)}),this.app.post("/createnew",gatherCustomParams(),fhirAllergyRecord(a),insertUpdateRecord(this.pool),retrieveInProgress(this.pool),/*#__PURE__*/function(){var a=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function a(b,c){return regeneratorRuntime.wrap(function(a){for(;;)switch(a.prev=a.next){case 0:c.render("./pages/patient_landing",b.customparams);case 1:case"end":return a.stop();}},a)}));return function(){return a.apply(this,arguments)}}()),this}/**
	 * @author Frazer Smith
