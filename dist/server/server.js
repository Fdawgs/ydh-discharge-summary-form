...
return this.app.get("/",gatherCustomParams(),retrieveAwaitSignOff(this.pool,"dr",void 0),retrieveAwaitSignOff(this.pool,"nurse",void 0),retrieveAwaitSignOff(this.pool,"pharmacy",void 0),retrieveAwaitSignOff(this.pool,"any",void 0),function(a,b){b.render("./pages/home",a)}),this.app.get("/contributors",function(a,b){b.render("./pages/contributors")}),this.app.get("*",function(a,b){b.redirect("/")}),this.app.post("/discharge_summary",gatherCustomParams(),fhirEncounterRecord(a),function(a,b){b.render("./pages/discharge_summary",a.customparams)}),this.app.post("/patient",gatherCustomParams(),retrieveInProgress(this.pool),function(a,b){b.render("./pages/patient_landing",a.customparams)}),this.app.post("/continue",gatherCustomParams(),fhirEncounterRecord(a),insertUpdateRecord(this.pool),function(a,b){b.render("./pages/discharge_summary",a.customparams)}),this.app.post("/preview",gatherCustomParams(),function(a,b,c){var d={id:a.customparams.row_id,version:a.customparams.version};a.powerbi=d,c()},insertUpdateRecord(this.pool),function(a,b){b.render("./pages/preview",a.powerbi)}),this}/**
	 * @author Frazer Smith
